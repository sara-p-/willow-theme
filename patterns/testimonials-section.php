...
<div class="wp-block-group is-style-light-green-on-green"
  ...
  <div class="wp-block-group alignwide">
    ...
    <div class="wp-block-group">
      <!-- wp:heading {"textAlign":"center","level":1,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|16"}}}} -->
      ...
      <div class="wp-block-group">
        <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|16","margin":{"bottom":"var:preset|spacing|16"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
        ...
        <p class="has-text-align-center has-off-white-color has-text-color has-link-color"
          style="font-style:italic;font-weight:400">Average 4.9/5 rating across all reviews</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
